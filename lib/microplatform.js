...
module.exports = function(config){
  ...
  var version  = config.version || pkg.version
  ...
  var help = function(){
    console.log()
    console.log(chalk.bold("  "+ name +" " +chalk.green("v" + config.version)) + chalk.grey(" - powered by surge.sh "))
    ...
    console.log("    "+ cmd +" releases <domain>    List publishing history of project")
    console.log("    "+ cmd +" rewind <domain>      Rollback to previous release")
    console.log("    "+ cmd +" forward <domain>     Removes <domain> from the web")
